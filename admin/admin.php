                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <a href="add-admin.php" class="btn btn-primary m-0">Add Admin</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" class="display" style="width:100%">
                                        ...
                                        <tbody class="text-center">
                                            <?php
                                            $fetchUsers = $userFacade->fetchAdmin();
                                            foreach ($fetchUsers as $users) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="update-admin.php?user_id=<?= $users["id"] ?>" class="btn btn-primary btn-sm">
                                                            <span class="fas fa-fw fa-edit"></span> Update</a>
                                                        <a href="delete-admin.php?user_id=<?= $users["id"] ?>" class="btn btn-danger btn-sm">
