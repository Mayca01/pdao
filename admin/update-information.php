        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <?php
                        $fetchInformationById = $informationsFacade->fetchInformationById($informationId);
                        foreach ($fetchInformationById as $informations) { ?>
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <h6 class="m-0 font-weight-bold">Update Announcement</h6>
                                </div>
                                <form action="update-information-action.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" id="title" name="title" placeholder="Title" value="<?= $informations["title"] ?>">
                                                        ...
                                                        <div class="form-floating">
                                                            <textarea class="form-control p-2" name="description" style="height: 200px; overflow: hidden"><?= $informations["description"] ?></textarea>
                                                        </div>

                                                        <input type="hidden" name="old_image" value="<?= $informations["image"] ?>">
                                                        <input type="hidden" name="information_id" value="<?= $informations["id"] ?>">
